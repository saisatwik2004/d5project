...
Updated for Aiven MySQL database connection.
"""
import os
...
MIDDLEWARE = [
    ...
    # 'whitenoise.middleware.WhiteNoiseMiddleware',  # Uncomment after: pip install whitenoise
...
# Database - Aiven MySQL Configuration with Environment Variables
DATABASES = {
    'default': {
